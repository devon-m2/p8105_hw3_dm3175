...
The NOAA dataset contains data from the NOAA National Climatic Data Center retrieved on August 15, 2017. The dataset contains `r nrow(NOAA_data)` rows and `r ncol(NOAA_data)` columns. 
...
Each of the weather stations collect a different combination of variables listed above. For reference, there are 
