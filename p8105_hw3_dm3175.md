...
The most helpful variables for this analysis are the `order_id`, `product_id`, `order_dow`, `order_hour_of_day` and `aisle_id`. All variables are integers except for `eval_set`, `product_name`, `aisle`, `department`
